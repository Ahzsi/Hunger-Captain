...
Check out [FRONTEND LIVE DEMO](https://hunger-captain-frontend.ahzsi.repl.co/) here!!

Check out [API LIVE DEMO](https://hunger-captain-backend.ahzsi.repl.co/) here!!
...
1. Git Clone https://github.com/Ahzsi/Hunger-Captain.git
